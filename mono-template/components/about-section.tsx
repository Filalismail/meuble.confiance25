...
export function AboutSection({ shopName = "Thika 25", shopNameAr = "ثقة 25" }: AboutSectionProps) {
  ...
  return (
    <section
      id="about"
      className="w-full bg-[#F5F5F7] py-24 md:py-32 px-6"
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          <div className="shrink-0">
            <div className="relative w-40 h-40 md:w-52 md:h-52 rounded-full overflow-hidden bg-white border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              <Image
                src="/logo.jpg"
                alt="مملكة الثقة 25"
                fill
          ...
          >
            <p className="text-muted-foreground text-sm leading-loose md:text-base md:leading-loose max-w-2xl">
              {locale === "fr"
