  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/30 flex flex-col md:flex-row animate-modal-in"
        dir={isRTL ? "rtl" : "ltr"}
      >
        {/* Close button */}
        <button
